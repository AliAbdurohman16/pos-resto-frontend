            ...
            <div className="grid grid-cols-4 gap-4 px-10 py-4 w-[100%]">
                {
                    menus.map((item) => {
                        return (
                            <div key={item.id} className="flex flex-col items-start justify-between p-4 rounded-lg h-[100px] cursor-pointer" style={{backgroundColor: item.bgColor}} onClick={() => {setSelected(item); setItemId(0); setItemCount(0);}}>
