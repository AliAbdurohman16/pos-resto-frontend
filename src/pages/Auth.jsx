    ...
    return (
        <div className="flex min-h-screen w-full">
            ...
            <div className="w-1/2 relative flex items-center justify-center bg-cover">
                {/* BG Image */}
                <img src={restaurant} className="w-full h-full object-cover" alt="Restaurant Image" />

                {/* Black Overlay */}
                <div className="absolute inset-0 bg-black bg-black/80"></div>
            ...
            <div className="w-1/2 min-h-screen bg-[#1a1a1a] p-10">
                <div className="flex flex-col items-center gap-2">
                    <img src={logo} className="h-14 w-14 border-2 rounded-full p-1" alt="Restro Logo" />
